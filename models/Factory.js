...
module.exports.getCardOfType = function (type){
  ...
  switch (type){
    case 'Toefl': 
      card.fields.push({content: {type: 'inputchecked', text: 'University Code', input: '', checked1: false, checked2: false, text1: 'Sent to university', text2: 'Received by university'}});
